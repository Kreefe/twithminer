...
twitch_miner = TwitchChannelPointsMiner(
    username="Kreechen",
    password="csy20112011mamapapa",           # If no password will be provided, the script will ask interactively
    ...
    logger_settings=LoggerSettings(
        ...
        telegram=Telegram(                                                          # You can omit or set to None if you don't want to receive updates on Telegram
            chat_id=6261114148,                                                      # Chat ID to send messages @getmyid_bot
            token="7065417538:AAFWyV7fIEyGmi-wRCVNx9916IAi4LjmO6Q",                          # Telegram API token @BotFather
